...
SRCFILES := device/ch32v203/startup.c

# Check specific files
ifneq (,$(findstring $(PART), f6 g6 k6 c6))
LDFLAGS += -T device/ch32v203/linker_32_10.ld
else ifneq (,$(findstring $(PART), f8 g8 k8 c8))
LDFLAGS += -T device/ch32v203/linker_64_20.ld
else ifneq (,$(findstring $(PART), rb))
LDFLAGS += -T device/ch32v203/linker_128_64.ld
else
